...
xhr.onload = function(e) {
	...
	if (this.status == 200) {
		...
		myStatus = 'loaded media (preloaded)';
...
xhr.onprogress = function(e) {
	...
	if (elapsed > 0) {
		...
		if (eta > 60) {
			...
			myStatus = '[' + (preloadQueueIndex + 1) + '/' + preloadQueue.length + '] (' + speed + ' ) preloading - ' + percent + '% done - ' + eta + ' minute(s) remaining.';
			...
			myStatus = '[' + (preloadQueueIndex + 1) + '/' + preloadQueue.length + '] (' + speed + ' ) preloading - ' + percent + '% done - ' + eta + ' second(s) remaining.';
